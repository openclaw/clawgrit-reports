...
Run ID: `kova-2026-07-10T144424Z`
Mode: execution
...
- Markdown report: /home/runner/_work/openclaw/openclaw/.artifacts/kova/reports/live-openai-candidate/kova-2026-07-10T144424Z-release.md
- JSON report: /home/runner/_work/openclaw/openclaw/.artifacts/kova/reports/live-openai-candidate/kova-2026-07-10T144424Z-release.json
- Retained gate artifacts: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/release-gates/kova-2026-07-10t144424z
...
- agent-cold-warm-message/mock-openai-provider: 1 sample(s); peakRssMb median 867.1MB p95 867.1MB max 867.1MB; cpuPercentMax median 141.8% p95 141.8% max 141.8%; agentTurnMs median 5031ms p95 5031ms max 5031ms; coldAgentTurnMs median 5031ms p95 5031ms max 5031ms; warmAgentTurnMs median 5001ms p95 5001ms max 5001ms

## Resource Roles

- Measurement scope: product
- Headline contract: `primary-role-product-scope-v2`
- agent-cli: RSS 867.1 MB; CPU 141.8%; scenario agent-cold-warm-message/mock-openai-provider
- agent-process: RSS 867.1 MB; CPU 141.8%; scenario agent-cold-warm-message/mock-openai-provider
- command-tree: RSS 867.1 MB; CPU 141.8%; scenario agent-cold-warm-message/mock-openai-provider
- status-cli: RSS 489.4 MB; CPU 138.8%; scenario agent-cold-warm-message/mock-openai-provider

## Target Cleanup

- Runtime: `kova-local-1783694664756`
- Result: removed
- Command: `ocm runtime remove 'kova-local-1783694664756' --json`
- Exit: 0
- Duration: 445ms
...
- Harness env: `kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z`
- Likely owner on failure: OpenClaw
- Objective: Send cold and warm simple messages through `openclaw agent --local`, verify mock-provider responses, and attribute latency before, during, and after provider work.
- agent-cli RSS: 867.1 MB
- Resource measurement scope: product
- Resource headline contract: `primary-role-product-scope-v2`
- Tracked total peak RSS: 867.1 MB
- Max CPU: 141.8%
- Resource samples: 15
- Command tree peak RSS: 867.1 MB
- Gateway peak RSS: 0 MB
- Resource by role:
  - agent-cli: RSS 867.1 MB; CPU 141.8%
  - agent-process: RSS 867.1 MB; CPU 141.8%
  - command-tree: RSS 867.1 MB; CPU 141.8%
  - status-cli: RSS 489.4 MB; CPU 138.8%
- Cold ready: 1139 ms
...
- Slowest OpenClaw span: plugins.metadata.scan 54.07 ms
- Open OpenClaw spans: 0 (0 required)
- Key OpenClaw spans: plugins.metadata.scan max 54.07ms open 0
- OpenClaw event-loop max: unknown ms
- OpenClaw provider request max: 2053 ms
- Structured event-loop delay: unknown ms
- Runtime deps staging: unknown ms
- Runtime deps warm reuse: unknown (cold installs 0; warm restages unknown; warm max unknown ms)
- Provider/model timing: 2053 ms
- Agent turn: 5031 ms (true)
- Agent cold/warm: cold 5031 ms; warm 5001 ms; delta 30 ms
- Agent pre-provider: cold 2936 ms; warm 2844 ms; delta 92 ms
- Agent provider final: cold 1995 ms; warm 2053 ms
- Agent turn stats: count 2; p95 5029.5 ms; max 5031 ms; pre-provider p95 2931.4 ms
- Provider evidence: 1 request(s); provider work 1995 ms; pre-provider 2936 ms; post-provider 100 ms
- Agent latency diagnosis: cold agent turn 5031ms; pre-provider 2936ms; provider 1995ms.
- Agent containment: process leaks 0; gateway healthy true; status works true
- Agent turns:
  - cold: total 5031 ms; pre-provider 2936 ms; provider 1995 ms; post-provider 100 ms; route openai-responses; status unknown; issue unknown; response true; leaks 0
    - breakdown: pre-provider 2936ms; provider 1995ms; post-provider 100ms; unknown 2936ms; source none
  - warm: total 5001 ms; pre-provider 2844 ms; provider 2053 ms; post-provider 104 ms; route openai-responses; status unknown; issue unknown; response true; leaks 0
    - breakdown: pre-provider 2844ms; provider 2053ms; post-provider 104ms; unknown 2844ms; source none
...
- Resource peaks: CPU at 1119ms; RSS at 4102ms
- Diagnostic correlation:
  - CPU peaked at 141.8% around 1119ms
  - RSS peaked at 867.1 MB around 4102ms
  - Slowest OpenClaw span: plugins.metadata.scan 54.07ms
  - Provider/model timing max: 2053ms
- Top CPU process: pid 21846 139% agent-cli,agent-process,command-tree openclaw-agent
- Top RSS process: pid 22853 804.2 MB agent-cli,agent-process,command-tree openclaw-agent
...
- `ocm runtime build-local 'kova-local-1783694664756' --repo '/home/runner/_work/openclaw/openclaw' --force`
...
- `ocm runtime build-local 'kova-local-1783694664756' --repo '/home/runner/_work/openclaw/openclaw' --force`
  - status: 0
  - duration: 113444ms
  - resource samples: 115
  - peak sampled RSS: 11268.1 MB
  - max sampled CPU: 337.3%
  - role peaks: 
  - top CPU: pid 15173 264% build-tooling,command-tree,runtime-management node /home/runner/_work/openclaw/openclaw/node_modules/.bin/vite build
  - resource artifact: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/kova-2026-07-10T144424Z/kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z/resource-samples/target-setup-1.jsonl
...
- `ocm start 'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' --runtime 'kova-local-1783694664756' --no-service --json`
...
- `ocm start 'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' --runtime 'kova-local-1783694664756' --no-service --json`
  ...
  - max sampled CPU: 0%
  - role peaks: 
  - top CPU: pid 19247 0% command-tree,runtime-management [ocm] <defunct>
  - resource artifact: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/kova-2026-07-10T144424Z/kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z/resource-samples/provision-1.jsonl
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- 'onboard' '--non-interactive' '--accept-risk' '--mode' 'local' '--auth-choice' 'openai-api-key' '--skip-health' '--skip-ui' '--skip-search' '--skip-skills' '--skip-channels' '--skip-bootstrap' '--no-install-daemon' '--json' '--secret-input-mode' 'ref'`
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- 'onboard' '--non-interactive' '--accept-risk' '--mode' 'local' '--auth-choice' 'openai-api-key' '--skip-health' '--skip-ui' '--skip-search' '--skip-skills' '--skip-channels' '--skip-bootstrap' '--no-install-daemon' '--json' '--secret-input-mode' 'ref'`
  ...
  - duration: 10876ms
  - resource samples: 12
  - peak sampled RSS: 1482.6 MB
  - max sampled CPU: 221.7%
  - role peaks: 
  - top CPU: pid 20165 163% command-tree,package-manager npm install
  - resource artifact: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/kova-2026-07-10T144424Z/kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z/resource-samples/auth-setup-1.jsonl
...
- OpenClaw timeline parse errors: 0
- slowest OpenClaw span: plugins.metadata.scan 40ms
- most expensive repeated span: plugins.metadata.scan 9x 212.85ms
- OpenClaw event-loop max: unknownms
- OpenClaw provider request max: unknownms
- OpenClaw child process failures: 0
- collectors:
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- config set models.providers.openai.agentRuntime.id openclaw`
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- config set models.providers.openai.agentRuntime.id openclaw`
  ...
  - duration: 2123ms
  - resource samples: 4
  - peak sampled RSS: 739.6 MB
  - max sampled CPU: 140.9%
  - role peaks: 
  - top CPU: pid 21230 139% command-tree,uncategorized openclaw-config
  - resource artifact: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/kova-2026-07-10T144424Z/kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z/resource-samples/state-provision-1.jsonl
...
- OpenClaw timeline parse errors: 0
- slowest OpenClaw span: plugins.metadata.scan 52ms
- most expensive repeated span: plugins.metadata.scan 13x 327.05ms
- OpenClaw event-loop max: unknownms
- OpenClaw provider request max: unknownms
- OpenClaw child process failures: 0
- collectors:
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- agent --local --agent main --session-id kova-agent-cold-warm --message 'Reply with exact ASCII text KOVA_AGENT_OK only.' --thinking off --timeout 120 --json`
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- agent --local --agent main --session-id kova-agent-cold-warm --message 'Reply with exact ASCII text KOVA_AGENT_OK only.' --thinking off --timeout 120 --json`
  ...
  - duration: 5031ms
  - resource samples: 6
  - peak sampled RSS: 736.1 MB
  - max sampled CPU: 141.8%
  - role peaks: 
  - top CPU: pid 21846 139% agent-cli,agent-process,command-tree openclaw-agent
  - resource artifact: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/kova-2026-07-10T144424Z/kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z/resource-samples/cold-agent-turn-1.jsonl
...
- OpenClaw timeline parse errors: 0
- slowest OpenClaw span: plugins.metadata.scan 52.32ms
- most expensive repeated span: plugins.metadata.scan 16x 413.78ms
- OpenClaw event-loop max: unknownms
- OpenClaw provider request max: 1995ms
- OpenClaw child process failures: 0
- collectors:
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- agent --local --agent main --session-id kova-agent-cold-warm --message 'Reply with exact ASCII text KOVA_AGENT_OK only.' --thinking off --timeout 120 --json`
  ...
  - duration: 5001ms
  - resource samples: 6
  - peak sampled RSS: 867.1 MB
  - max sampled CPU: 135.9%
  - role peaks: 
  - top CPU: pid 22853 134% agent-cli,agent-process,command-tree openclaw-agent
  - resource artifact: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/kova-2026-07-10T144424Z/kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z/resource-samples/warm-agent-turn-1.jsonl
...
- OpenClaw timeline parse errors: 0
- slowest OpenClaw span: plugins.metadata.scan 54.07ms
- most expensive repeated span: plugins.metadata.scan 19x 496.16ms
- OpenClaw event-loop max: unknownms
- OpenClaw provider request max: 2053ms
- OpenClaw child process failures: 0
- collectors:
  - service: PASS, 5ms, artifacts 0
  - readiness: INFO, 0ms, artifacts 0
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- status`
...
- `ocm @'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' -- status`
  ...
  - duration: 1871ms
  - resource samples: 3
  - peak sampled RSS: 489.4 MB
  - max sampled CPU: 138.8%
  - role peaks: 
  - top CPU: pid 23716 136% command-tree,status-cli openclaw
  - resource artifact: /home/runner/_work/openclaw/openclaw/.artifacts/kova/home/live-openai-candidate/artifacts/kova-2026-07-10T144424Z/kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z/resource-samples/post-agent-health-1.jsonl
...
- OpenClaw timeline parse errors: 0
- slowest OpenClaw span: plugins.metadata.scan 54.07ms
- most expensive repeated span: plugins.metadata.scan 23x 577.68ms
- OpenClaw event-loop max: unknownms
- OpenClaw provider request max: 2053ms
- OpenClaw child process failures: 0
- collectors:
...
- destroyed
- cleanup command: `ocm env destroy 'kova-agent-cold-warm-message-mock-openai-provider-kova-2026-07-10t144424z' --yes`
- cleanup status: 0
- cleanup duration: 963ms
